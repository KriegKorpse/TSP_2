...
using namespace std;
   ...
   Cone::Cone(const Cone& obj) { // конструктор конуса с центром в нач. коорд-т.
      x = obj.x; y = obj.y; z = obj.z;
      this->r = obj.r; this->h = obj.h;
   }
   ...
   int Cone::operator == (const Cone & obj) {
      return (this->x == obj.x) && (this->y == obj.y) && (this->z == obj.z) && (this->r == obj.r) && (this->h == obj.h);
   }
